...
Most of these come down to network reality or how topcoder serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

topcoder rate-limits like any public site. tc already paces
...
Where a surface is gated, tc reads a cookie or token you supply
...
`tc`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what tc actually did
