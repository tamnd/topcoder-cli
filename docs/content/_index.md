---
title: "tc"
description: "Browse TopCoder challenges and member profiles"
heroTitle: "topcoder, from the command line"
heroLead: "Browse TopCoder challenges and member profiles One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
tc links <path>           # the pages it links to, each addressable
tc serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading topcoder by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address topcoder as
  `topcoder://` URIs and follow links across sites. See
